...
## Superseded (2026-04-06)

`suta-ro` は旧 GitHub ユーザー名に引っ張られて macOS アカウント作成時に使ってしまったもの。現在の GitHub ユーザー名 `yu-sz` に合わせてホスト名・ユーザー名・`darwinConfigurations` キーをすべて `yu-sz` に統一した。
